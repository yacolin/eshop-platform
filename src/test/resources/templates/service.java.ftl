...
<#assign hasTimeField = false>
<#list table.fields as field>
<#if isTimeField(field) && (!isAutoCol(field) || field.name == "created_at" || field.name == "updated_at")>
...
public class ${table.serviceName} {
    ...
    public PageResult<${table.entityName}VO> page(int page, int size) {
        Page<${table.entityName}> p = new Page<>(normalizePage(page), normalizeSize(size));
    ...
    /** 新增 */
    public ${table.entityName}VO create(${table.entityName}CreateReq req) {
     ...
     */
    public ${table.entityName}VO update(Long id, ${table.entityName}UpdateReq req) {
...
<#if isTimeField(field)>
        vo.set${field.capitalName}(TimeUtil.toEpochMillis(entity.get${field.capitalName}()));
<#else>
    ...
    private void apply(${table.entityName} entity, ${table.entityName}CreateReq req) {
<#list table.fields as field>
<#if !field.keyFlag && !isAutoCol(field)>
    ...
    private void apply(${table.entityName} entity, ${table.entityName}UpdateReq req) {
<#list table.fields as field>
<#if !field.keyFlag && !isAutoCol(field)>
        entity.set${field.capitalName}(req.get${field.capitalName}());
</#if>
