package com.example.eshopplatform.sys.role.dto;
 ...
 */
@Data
@Schema(description = "B端角色定义表更新请求")
public class RolesUpdateReq {
    ...
    /** true-启用 false-禁用（null=保留原值） */
    @Schema(description = "true-启用 false-禁用（null=保留原值）")
