-- ============================================================================
-- 清理所有种子数据（按依赖顺序）
-- 注：取自配套电商业务库种子脚本；其中 mch_roles / mch_role_permissions 为上游
-- 旧表名，已按现 schema 修正为 mch_merchant_roles / mch_merchant_role_permissions。
-- ============================================================================
...
-- 商户
TRUNCATE TABLE mch_merchant_role_permissions;
TRUNCATE TABLE mch_merchant_roles;
...
ALTER TABLE mch_merchant_roles AUTO_INCREMENT = 1;
ALTER TABLE mch_merchant_role_permissions AUTO_INCREMENT = 1;
